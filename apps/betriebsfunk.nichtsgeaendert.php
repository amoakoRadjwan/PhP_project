...
<html>
<head>
<title>Funkmeldung best&auml;tigen.</title>
...
<fieldset>
<br><br> 
<h2 align="center">Best&auml;tigung der Funkmeldung Betriebsfunk</h2>
...
//   VERBINDUNG ZU MYSQL AUFNEHMEN UND DATEN LESEN      
  ...
  if ($pruefung==1)
  {
    $SQLString = "Update betriebsfunk SET Zeitstempel=NOW() WHERE EDV=\"".$EDV."\";";
 //   echo $SQLString;
    $Ergebnis = mysql_query($SQLString, $Verbindung);
    if ($Ergebnis) 
	{echo "Vielen Dank f&uuml;r die R&uuml;ckmeldung! Sie k&ouml;nnen Ihre Daten jederzeit einsehen und &auml;ndern unter <a href=\"https://www.intranet-dlrg.net/apps\">https://www.intranet-dlrg.net/apps<a>";} else {echo "Es ist ein Fehler aufgetreten! Ihr Eintrag wurde nicht gespeichert. Bitte versuchen Sie es zu einem sp&auml;teren Zeitpunkt erneut. Vielen Dank f&uuml;r Ihr Verst&auml;ndnis!";
  } } else {
