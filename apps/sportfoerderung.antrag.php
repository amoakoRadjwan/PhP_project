...
function write_eintrag($Datenbankname)
{
  ...
  mysql_real_escape_string($RegNr);
  mysql_real_escape_string($gueltig_bis);
...
function write_grunddaten($Datenbankname, $EDV)
{
  ...
  mysql_real_escape_string($verantwortlicher);
  mysql_real_escape_string($email);
 // mysql_real_escape_string($geteilt);
 // mysql_real_escape_string($eV);
 // mysql_real_escape_string($einnahmen);
 // mysql_real_escape_string($jugendliche);
 // mysql_real_escape_string($erwachsene);
