...
$SQLString = "SELECT betriebsfunk.EDV, email_einsatz, Landkreis_Stadt, DLRG_Bezirk, Funknetz, Anzahl_ortsfest, Anzahl_mobil, nord, ost, Adresse, Urkunde_gueltig_bis, LV, Bemerkung, Passwort FROM Gliederung, betriebsfunk WHERE Gliederung.EDV=betriebsfunk.EDV AND ID>=".$von." AND ID<=".$bis.";";
