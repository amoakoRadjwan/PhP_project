...
function write_eintrag($Datenbankname)
{
  ...
  // echo $SQLString;
  $Ergebnis = mysql_query($SQLString, $Verbindung);
  if ($Ergebnis) echo "<fieldset><font color=\"green\"><p align=center><b>Vielen Dank - der neue Fach&uuml;bungsleiter wurden gespeichert.</b></font></p></fieldset>"; else echo "<fieldset><font color=\"red\"><p align=center><b>Es ist ein Fehler aufgetreten. Bitte versuchen Sie es sp&auml;ter noch einmal.</b></font></p></fieldset>";  
...
function write_grunddaten($Datenbankname, $EDV)
{
  ...
  // echo $SQLString;
  $Ergebnis = mysql_query($SQLString, $Verbindung);
  if ($Ergebnis) echo "<fieldset><font color=\"green\"><p align=center><b>Vielen Dank - der Antrag wurde erfolgreich gespeichert. Bis zum Antragsschluss k&ouml;nnen die Daten jederzeit erneut gespeichert weden.</b></font></p></fieldset>"; else echo "<fieldset><font color=\"red\"><p align=center><b>Es ist ein Fehler aufgetreten. Bitte versuchen Sie es sp&auml;ter noch einmal.</b></font></p></fieldset>";  
  mysql_close($Verbindung);  
  $Schalter2="";
}
...
{  if (($EDV==$_SESSION["EDV"]) || ($_SESSION["EDV"]=="0200000"))
	{ 
     ...
     // echo $SQLString;
      $Ergebnis = mysql_query($SQLString, $Verbindung);
	if ($Ergebnis) echo "<fieldset><font color=\"green\"><p align=center><b>Vielen Dank - der Fach&uuml;bungsleiter wurde erfolgreich gel&ouml;scht.</font></b></p></fieldset>"; else echo "<fieldset><font color=\"red\"><p align=center><b>Es ist ein Fehler aufgetreten. Bitte versuchen Sie es sp&auml;ter noch einmal.</b></font></p></fieldset>";  
      mysql_close($Verbindung);  
	}
      $id_loeschen="";
}
