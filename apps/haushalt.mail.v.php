...
$SQLString = "SELECT meldetHH.EDV, email_vorsitz, Passwort2 FROM Gliederung, meldetHH WHERE Gliederung.EDV=meldetHH.EDV AND ID>=".$von." AND ID<=".$bis." AND OeRV=1;";
